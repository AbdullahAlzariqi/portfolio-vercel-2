  ...
  return (
    <>
      ...
      >
        ...
        >
          {/* Page 1 */}
          <div className="pages flex items-center  h-screen min-w-full">
            <div className="w-8 mr-[5px]" />
            <div className="page-1 row flex items-center justify-center h-screen min-w-full mt-20">
